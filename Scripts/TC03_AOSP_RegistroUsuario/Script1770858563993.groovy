...
String counterPath = System.getProperty("user.dir") + "/resources/email_counter.txt"

File file = new File(counterPath)
int counter = Integer.parseInt(file.text.trim())

String email = "testingepic${counter}@yopmail.com"

println("Generated email: " + email)

counter++
file.text = counter.toString()

// ===== USAR EL EMAIL EN EL REGISTRO =====
